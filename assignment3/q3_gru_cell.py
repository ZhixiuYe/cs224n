...
class GRUCell(tf.contrib.rnn.RNNCell):
    ...
    def __call__(self, inputs, state, scope=None):
        ...
        with tf.variable_scope(scope):
            ...
            b_z = tf.get_variable("b_z", initializer=[0.] * self.state_size, dtype=tf.float32)
            ...
            b_r = tf.get_variable("b_r", initializer=[0.] * self.state_size, dtype=tf.float32)
            ...
            b_o = tf.get_variable("b_o", initializer=[0.] * self.state_size, dtype=tf.float32)
